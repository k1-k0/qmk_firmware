...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[0] = LAYOUT_split_3x5_2(LT(5, KC_Q), KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, LT(5, KC_P), LGUI_T(KC_A), LALT_T(KC_S), LCTL_T(KC_D), LSFT_T(KC_F), LT(4, KC_G), LT(4, KC_H), RSFT_T(KC_J), RCTL_T(KC_K), RALT_T(KC_L), RGUI_T(KC_SCLN), KC_Z, LT(4, KC_X), LT(2, KC_C), LT(3, KC_V), KC_B, KC_N, LT(3, KC_M), LT(2, KC_COMM), LT(4, KC_DOT), KC_SLSH, LT(2, KC_SPC), LT(3, KC_ENT), LT(3, KC_ESC), LT(2, KC_BSPC)),
                                                              [1] = LAYOUT_split_3x5_2(KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, LT(4, KC_DOT), KC_SLSH, KC_SPC, KC_ENT, LT(3, KC_ESC), LT(2, KC_BSPC)),
                                                              [2] = LAYOUT_split_3x5_2(KC_SLSH, KC_7, KC_8, KC_9, KC_PLUS, CW_TOGG, KC_PGUP, KC_UP, KC_PGDN, KC_CAPS, LGUI_T(KC_PAST), LALT_T(KC_4), LCTL_T(KC_5), LSFT_T(KC_6), KC_MINS, KC_HOME, RSFT_T(KC_LEFT), RCTL_T(KC_DOWN), RALT_T(KC_RGHT), RGUI_T(KC_END), KC_0, KC_1, KC_2, KC_3, KC_EQL, KC_TAB, KC_INS, KC_APP, KC_DEL, KC_PSCR, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
                                                              ...
                                                              [5] = LAYOUT_split_3x5_2(KC_BTN5, KC_WH_D, KC_MS_U, KC_WH_U, KC_BTN4, KC_BTN4, KC_WH_U, KC_MS_U, KC_WH_D, KC_BTN5, KC_WH_L, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_R, KC_WH_L, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_R, KC_BTN5, KC_BTN2, KC_BTN3, KC_BTN1, KC_BTN4, KC_BTN4, KC_BTN1, KC_BTN3, KC_BTN2, KC_BTN5, KC_ACL1, KC_ACL2, KC_ACL2, KC_ACL1)};
...
const uint16_t PROGMEM dg_combo[] = {LCTL_T(KC_D), LT(4, KC_G), COMBO_END};
const uint16_t PROGMEM as_combo[] = {LGUI_T(KC_A), LALT_T(KC_S), COMBO_END};
const uint16_t PROGMEM we_combo[] = {KC_W, KC_E, COMBO_END};
const uint16_t PROGMEM er_combo[] = {KC_E, KC_R, COMBO_END};
const uint16_t PROGMEM wr_combo[] = {KC_W, KC_R, COMBO_END};
const uint16_t PROGMEM xc_combo[] = {LT(4, KC_X), LT(2, KC_C), COMBO_END};
const uint16_t PROGMEM cv_combo[] = {LT(2, KC_C), LT(3, KC_V), COMBO_END};
const uint16_t PROGMEM xv_combo[] = {LT(4, KC_X), LT(3, KC_V), COMBO_END};
...
const uint16_t PROGMEM kh_combo[]     = {RCTL_T(KC_K), LT(4, KC_H), COMBO_END};
...
const uint16_t PROGMEM mcmm_combo[]   = {LT(3, KC_M), LT(2, KC_COMM), COMBO_END};
const uint16_t PROGMEM cmmdot_combo[] = {LT(2, KC_COMM), LT(4, KC_DOT), COMBO_END};
const uint16_t PROGMEM mdot_combo[]   = {LT(3, KC_M), LT(4, KC_DOT), COMBO_END};
...
const uint16_t PROGMEM sx_combo[] = {LALT_T(KC_S), LT(4, KC_X), COMBO_END};
const uint16_t PROGMEM dc_combo[] = {LCTL_T(KC_D), LT(2, KC_C), COMBO_END};
const uint16_t PROGMEM fv_combo[] = {LSFT_T(KC_F), LT(3, KC_V), COMBO_END};
...
const uint16_t PROGMEM jm_combo[]   = {RSFT_T(KC_J), LT(3, KC_M), COMBO_END};
const uint16_t PROGMEM kcmm_combo[] = {RCTL_T(KC_K), LT(2, KC_COMM), COMBO_END};
const uint16_t PROGMEM ldot_combo[] = {RALT_T(KC_L), LT(4, KC_DOT), COMBO_END};

combo_t key_combos[COMBO_COUNT] = {
    [SD_CAPS]      = COMBO(sd_combo, KC_CAPS),
    [DF_QUOT]      = COMBO(df_combo, KC_QUOT),
    [DG_TAB]       = COMBO(dg_combo, KC_TAB),
