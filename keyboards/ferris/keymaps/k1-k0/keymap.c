...
#define MOUSE_Q LT(5, KC_Q)
#define MOUSE_P LT(5, KC_P)
...
#define SYMBOLS_G LT(4, KC_G)
#define SYMBOLS_H LT(4, KC_H)
...
#define MULTIMEDIA_Z LT(6, KC_Z)
#define MULTIMEDIA_SLSH LT(6, KC_SLSH)

#define RAISE_C LT(2, KC_C)
#define LOWER_V LT(1, KC_V)
#define MEH_B MEH_T(KC_B)

#define MEH_N MEH_T(KC_N)
#define LOWER_M LT(1, KC_M)
#define RAISE_COMM LT(2, KC_COMM)

#define RAISE_SPACE LT(2, KC_SPC)
#define LOWER_TAB LT(1, KC_TAB)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAMING]     = LAYOUT_split_3x5_2(KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_SPC, KC_ESC, LOWER_ENTER, RAISE_BSPC),
};
