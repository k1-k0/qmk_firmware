...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(KC_NO, KC_NO, LT(_MULTIMEDIA,KC_Q), KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, LT(_MULTIMEDIA,KC_P), KC_NO, KC_NO, KC_NO, LGUI_T(KC_A), LALT_T(KC_S), LCTL_T(KC_D), LSFT_T(KC_F), KC_G, KC_H, RSFT_T(KC_J), RCTL_T(KC_K), RALT_T(KC_L), RGUI_T(KC_SCLN), KC_NO, KC_NO, LT(_MOUSE,KC_Z), KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, LT(_MOUSE,KC_SLSH), KC_NO, LT(_ADJUST,KC_TAB), LT(_RAISE,KC_SPC), LT(_LOWER,KC_ENT), LT(_LOWER,KC_ESC), LT(_RAISE,KC_BSPC), LT(_ADJUST,KC_DEL)),
  [1] = LAYOUT(KC_NO, KC_NO, LT(_MULTIMEDIA,KC_QUOT), KC_COMM, KC_DOT, KC_P, KC_Y, KC_F, KC_G, KC_C, KC_R, LT(_MULTIMEDIA,KC_L), KC_NO, KC_NO, KC_NO, LGUI_T(KC_A), LALT_T(KC_O), LCTL_T(KC_E), LSFT_T(KC_U), KC_I, KC_D, RSFT_T(KC_H), RCTL_T(KC_T), RALT_T(KC_N), RGUI_T(KC_S), KC_NO, KC_NO, LT(_MOUSE,KC_SCLN), KC_Q, KC_J, KC_K, KC_X, KC_B, KC_M, KC_W, KC_V, LT(_MOUSE,KC_Z), KC_NO, LT(_ADJUST,KC_TAB), LT(_RAISE,KC_SPC), LT(_LOWER,KC_ENT), LT(_LOWER,KC_ESC), LT(_RAISE,KC_BSPC), LT(_ADJUST,KC_DEL)),
  [2] = LAYOUT(KC_NO, KC_NO, LT(_MULTIMEDIA,KC_Q), KC_W, KC_F, KC_P, KC_B, KC_J, KC_L, KC_U, KC_Y, LT(_MULTIMEDIA,KC_SCLN), KC_NO, KC_NO, KC_NO, LGUI_T(KC_A), LALT_T(KC_R), LCTL_T(KC_S), LSFT_T(KC_T), KC_G, KC_M, RSFT_T(KC_N), RCTL_T(KC_E), RALT_T(KC_I), RGUI_T(KC_O), KC_NO, KC_NO, LT(_MOUSE,KC_Z), KC_X, KC_C, KC_D, KC_V, KC_K, KC_H, KC_COMM, KC_DOT, LT(_MOUSE,KC_SLSH), KC_NO, LT(_ADJUST,KC_TAB), LT(_RAISE,KC_SPC), LT(_LOWER,KC_ENT), LT(_LOWER,KC_ESC), LT(_RAISE,KC_BSPC), LT(_ADJUST,KC_DEL)),
  [3] = LAYOUT(KC_NO, KC_NO, KC_PSLS, KC_AMPR, KC_ASTR, KC_LPRN, KC_DQUO, KC_EQL, KC_QUOT, KC_GRV, KC_BSLS, KC_PIPE, KC_NO, KC_NO, KC_NO, KC_PAST, KC_DLR, KC_PERC, KC_CIRC, KC_QUOT, KC_MINS, KC_LPRN, KC_LBRC, KC_LCBR, KC_LT, KC_NO, KC_NO, KC_RPRN, KC_EXLM, KC_AT, KC_HASH, KC_GRV, KC_UNDS, KC_RPRN, KC_RBRC, KC_RCBR, KC_GT, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
  ...
  [6] = LAYOUT(KC_NO, KC_NO, KC_SCRL, KC_BRIU, KC_BRID, KC_HELP, DF(2), DF(2), KC_HELP, KC_BRID, KC_BRIU, KC_SCRL, KC_NO, KC_NO, KC_NO, KC_MNXT, KC_VOLU, KC_VOLD, KC_MPRV, DF(1), DF(1), KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, KC_NO, KC_NO, KC_EXEC, KC_MPLY, KC_MUTE, KC_MSTP, DF(0), DF(0), KC_MSTP, KC_MUTE, KC_MPLY, KC_EXEC, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
  [7] = LAYOUT(KC_NO, KC_NO, KC_BTN5, KC_BTN2, KC_BTN3, KC_BTN1, KC_BTN4, KC_BTN4, KC_BTN1, KC_BTN3, KC_BTN2, KC_BTN5, KC_NO, KC_NO, KC_NO, KC_ACL0, KC_MS_R, KC_MS_U, KC_MS_D, KC_MS_L, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_ACL0, KC_NO, KC_NO, DF(0), KC_WH_R, KC_WH_U, KC_WH_D, KC_WH_L, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, DF(0), KC_NO, KC_ACL0, QK_LOCK, KC_ACL2, KC_ACL2, QK_LOCK, KC_ACL0)
};
